	...
	return (
		...
		<main className="min-w-0 xl:col-start-1">
			...
			<section className="mb-10">
				...
				<div
					className={prose}
					dangerouslySetInnerHTML={{ __html: localizeHtml(walkthrough.why, lang) }}
				/>
			</section>
							...
							<Appear key={i} className="scroll-mt-[110px]">
								...
								<div
									...
									dangerouslySetInnerHTML={{
										__html: localizeHtml(excerpt.notice, lang),
									}}
								/>
							</Appear>
						)
