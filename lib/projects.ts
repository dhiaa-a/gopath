...
export const projects: Project[] = [
	...
	// ── TIER 3 ──────────────────────────────────────────────────────────────
	{
		...
		what: "A gRPC service (e.g. a user service or a currency converter) defined in protobuf, compiled to Go, and implemented with real business logic. You'll cover unary calls, streaming, interceptors (gRPC's middleware), and a basic test client.",
		learn: [
