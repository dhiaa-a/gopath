	...
	return (
		<main className="mx-auto max-w-4xl px-6 py-16">
			...
			<h1 className="mb-3 font-serif text-4xl text-foreground">
				Read the code you already depend on.
			</h1>
			<p className="mb-6 max-w-2xl text-muted">
				Every working Go programmer eventually reads the standard
				library, and almost nothing teaches you how. Each walkthrough
				here takes one real file and reads it the way an experienced Go
				programmer would: where to enter, what to skip, what to notice,
				and what the code is defending against. The skill you are
				practising is not memorising these files. It is being able to
				open the next one on your own.
			</p>
			<p className="mb-6 max-w-2xl text-muted">
