	...
	return (
		<main className="mx-auto max-w-4xl px-6 py-16">
			...
			<div
				...
				dangerouslySetInnerHTML={{ __html: localizeHtml(capstone.why, lang) }}
			/>
					...
					{capstone.requirements.map((req) => (
						...
						>
							...
							<div
								...
								dangerouslySetInnerHTML={{ __html: localizeHtml(req.body, lang) }}
							/>
						</div>
					))}
				</div>
					...
					{capstone.seeds.map((s) => (
						...
						>
							<div className="mb-1 flex flex-wrap items-baseline justify-between gap-2">
								...
								{s.failureSlug ? (
									<Link
										href={lp(`/failures/${s.failureSlug}`)}
			...
			<section className="mb-12">
				...
				<div className="flex flex-col gap-2">
					{capstone.blindSpots.map((b) => (
						...
						>
							<Link
								href={lp(`/failures/${b.failureSlug}`)}
							...
							<div
								...
								dangerouslySetInnerHTML={{ __html: localizeHtml(b.reason, lang) }}
							/>
						</div>
					))}
				</div>
