...
import { projects, getProjectsByTier } from "@/lib/projects";
...
const tierMeta = {
  ...
  2: {
    num: "Tier 02",
    name: "Go Idioms",
    desc: "Write code that feels native to Go, not translated from Python or JS",
  },
  3: {
    num: "Tier 03",
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-12 px-6 pb-20 pt-24 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h1 className="mb-5 font-serif text-5xl leading-tight text-white">
              Learn Go by{" "}
              <em className="italic text-go-cyan">building real things</em>
            </h1>
            <p className="mb-8 max-w-lg text-lg leading-relaxed text-muted">
              No toy examples. No tutorial hell. Each project teaches you how Go
              actually thinks — through code you&apos;d write at a real job.
            </p>
          ...
          {/* Code window */}
          <div className="overflow-hidden rounded-lg border border-border bg-surface font-mono">
            <div className="flex items-center gap-2 border-b border-border bg-surface2 px-4 py-3">
              <span className="h-2.5 w-2.5 rounded-full bg-red-500/70" />
              <span className="h-2.5 w-2.5 rounded-full bg-yellow-500/70" />
              <span className="h-2.5 w-2.5 rounded-full bg-green-500/70" />
              <span className="ml-2 text-xs text-muted">main.go</span>
            </div>
...
func main() {
    ...
    srv.Shutdown(context.Background())
      ...
      <div className="border-y border-border bg-surface">
        <div className="mx-auto flex max-w-6xl flex-wrap justify-center gap-16 px-6 py-8">
          {[
            { n: "9", l: "Projects" },
            { n: "3", l: "Tiers" },
            { n: "40+", l: "Go concepts" },
      ...
      <section className="mx-auto max-w-6xl px-6 py-24" id="path">
        ...
        <p className="mb-12 max-w-xl text-muted">
          Each project unlocks the next. You&apos;ll never read ten pages of
          theory before writing a line of code.
        </p>
      ...
      >
        <div className="mx-auto max-w-6xl px-6 py-24">
          ...
          <p className="mb-12 max-w-xl text-muted">
            Tour of Go teaches syntax. Go by Example shows snippets. GoPath
            teaches you how to think in Go — by forcing you to build things.
          </p>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            {[
              ...
              },
              {
                ...
                b: "Every concept on the site links to the project that teaches it best — not a docs page. Code you can run.",
              },
              {
                icon: "🌉",
              ...
              >
                <div className="mb-3 text-xl">{d.icon}</div>
                <h3 className="mb-2 font-semibold text-white">{d.h}</h3>
                <p className="text-sm leading-relaxed text-muted">{d.b}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="mx-auto max-w-2xl px-6 py-24 text-center">
        ...
        <p className="mb-8 text-muted">
          Start with the File Renamer CLI — you&apos;ll be writing idiomatic Go
