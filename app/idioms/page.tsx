	...
	return (
		<main className="mx-auto max-w-4xl px-6 py-16">
			...
			<p className="mb-6 max-w-2xl text-muted">
				Every exercise is working Go with a green test suite, written
				the way you would write it coming from another language. Your
				job is to refactor until the tests stay green and a strict
				linter comes up clean, then compare your calls against a
				senior reviewer&apos;s walkthrough in the exercise&apos;s
				REVIEW.md. You do not read about idiom here; you refactor
				toward it under mechanical enforcement.
			</p>
